...
def test_add_new_pet_with_valid_data(name='Terry', animal_type='coon',
...
def test_add_new_pet_without_photo_with_valid_data(name='Bry', animal_type='maim_coon', age='3'):
    """Проверяем что можно добавить питомца с корректными данными без загрузки его фото"""
...
def test_add_photo_of_pet_valid_id(pet_photo='images/225.jpg'):
